...
-- this row makes hardcore pay out. Rate is 500 = ~62× normal Defense (rate 8), a
-- huge payout to reward the much harder run (Defense has no cap, so it scales up).
--
...
values ('defense_hard', 500.0, false, 0)
